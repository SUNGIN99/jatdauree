package com.example.jatdauree.src.domain.web.todaymenu;


import com.example.jatdauree.config.BaseException;
import com.example.jatdauree.config.BaseResponse;
import com.example.jatdauree.src.domain.web.todaymenu.dto.GetMainPageMenu;
import com.example.jatdauree.src.domain.web.todaymenu.dto.PostMainPageTMenu;
import com.example.jatdauree.src.domain.web.todaymenu.dto.PostMainPageTMenuRes;
import com.example.jatdauree.src.domain.web.todaymenu.service.TodayMenuService;
