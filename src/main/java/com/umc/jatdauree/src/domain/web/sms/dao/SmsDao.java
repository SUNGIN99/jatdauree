package com.umc.jatdauree.src.domain.web.sms.dao;

import com.umc.jatdauree.src.domain.app.customer.dto.PwRecovReq;
import com.umc.jatdauree.src.domain.app.customer.dto.UidRecovReq;
import com.umc.jatdauree.src.domain.web.seller.dto.PostSignUpAuthyReq;
import com.umc.jatdauree.src.domain.web.seller.dto.ReceivedNumConfReq;
...
public class SmsDao {
    ...
    public int smsCheckIdCustom(UidRecovReq receivedNumConfReq) {
        String query = "SELECT EXISTS(\n" +
                "    SELECT\n" +
                "        * \n" +
                "    FROM Sms WHERE phone = ?\n" +
